...
function NotificationRows({ values, onToggle }) {
  ...
  const rows = [
    { key: "notifications", title: "Admin Alerts", subtitle: "Receive request and escalation notifications" },
    { key: "emailDigest", title: "Weekly Email Digest", subtitle: "Get a summary of pending and completed admin work" },
  ];
...
export default function AdminProfile() {
  ...
  const initials = useMemo(() => {
    const seed = draft.name || draft.email || "A";
